...
const CONFIG = {
  ...
  invitation: {
    ...
    message: "서로의 가장 가까운 동료로 시작해\n이제는 평생을 함께할 동반자가 되었습니다.\n\n저희의 첫걸음을 축복해 주시면\n더없는 기쁨으로 간직하겠습니다."
  },
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "이동훈", bank: "국민은행", number: "756402-01-186886" },
      { role: "아버지", name: "이상현", bank: "농협은행", number: "352-2299-0454-73" },
      { role: "어머니", name: "최순덕", bank: "전북은행", number: "521-21-0361308" }
    ],
    bride: [
      { role: "신부", name: "이선우", bank: "우리은행", number: "1002-456-575578" },
      { role: "아버지", name: "이문규", bank: "OO은행", number: "000-000-000000" },
      { role: "어머니", name: "손주희", bank: "신한은행", number: "330-02-62665-4" }
    ]
  },
